      ...
      <div class="container">
        <div class="row">
          ...
          <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{route('pidum.store')}}" method="POST">
              @csrf
                <div class="card-body">
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">Nomor</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="no_terdakwa" >
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="jpu" >
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">Jenis Perkara</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="jenis_perkara" >
                    </div>
                  </div>
                  <div class="form-group row">
